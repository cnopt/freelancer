<?php
//This script runs when user likes a post
//Jas
if(!isset($_SESSION)) { 
    session_start(); 
} 
...
$conn = new mysqli($server, $username, $password, $db);
            ...
            $addLike = "INSERT INTO post_has_like (post_id, profile_id)
            VALUES ('$post_id', '$users_id' )";


                    if ($conn->query($addLike) === TRUE) {
                        
                        echo "<br><br><br><br><div class='alert alert-primary' role='alert'>You have liked the post</div>";
                        header("Location: /social_media/userFeed.php");
                        
                    } 
                    else {
                        
                        echo "<br><br><br><br><div class='alert alert-warning' role='alert'>You have already liked the post</div>";
                        header("Location: /social_media/userFeed.php");
                    }
